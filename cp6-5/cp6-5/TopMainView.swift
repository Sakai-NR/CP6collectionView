...
extension TopMainView {
    ...
    override func draw(_ rect: CGRect) {
        super .draw(rect)
        collectionViewFlowLayout.estimatedItemSize = CGSize(width: collectionView.contentSize.width, height: 10)
    }
}
